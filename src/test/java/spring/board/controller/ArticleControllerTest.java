...
class ArticleControllerTest {
    ...
    @Test
    void givenKeyword_whenSearchingArticleView_thenReturnsArticlesView() throws Exception {
        // given
    ...
    @DisplayName("[View] [GET] 게시글 상세 페이지 - 정상호출, 인증이 없을 땐 로그인 페이지로 이동")
    @Test
    ...
    @DisplayName("[View] [GET] 게시글 해시태그 검색 전용 페이지 - 정상호출, 해시태그 입력")
    @Test
