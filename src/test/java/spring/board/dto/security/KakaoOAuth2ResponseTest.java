package spring.board.dto.security;
...
class KakaoOAuth2ResponseTest {
    ...
    void givenMapFromJson_whenInstantiating_thenReturnsKakaoResponseObject() throws Exception {
        ...
        String serializedResponse = """
                {
                    "id": 1234567890,
                    "connected_at": "2022-12-14T00:12:34Z",
                    "properties": {
                        "nickname": "홍길동"
                    },
                    "kakao_account": {
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("connectedAt", ZonedDateTime.of(2022, 12, 14, 0, 12, 34, 0, ZoneOffset.UTC)
